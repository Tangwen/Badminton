package com.twm.pt.demo.badminton.utility;
...
public class StorageDirectory {
    ...
    public enum StorageType {
        /** Android Rom 中data目錄 */
        ST_Rom_DataDir,
        /** Android Rom 中data下app可操作目錄 */
        ST_Rom_AppDir,
        /** Android Rom 中data下cacsh可操作目錄 */
        ST_Rom_AppCacshDir,
        /** 最大的SD卡的根目錄 */
        ST_SDCard_RootDir,
    }
    ...
    public static File getStorageDirectory(Context mContext, StorageType st) {
        ...
        } else if (st.equals(StorageType.ST_Rom_AppCacshDir) && mContext!=null) {
            f = mContext.getApplicationContext().getCacheDir();
